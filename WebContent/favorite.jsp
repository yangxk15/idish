...
<html>
  <head>
    <base target="_parent" />
    <title>Favorite (Actually Kitchen)</title>
    ...
    <link href="files/favorite/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/favorite/data.js"></script>
    ...
    <script type="text/javascript">
      ...
      function check() {
          if ("${user.kitchen[0]}" == "") {
        	  ...
        	  document.getElementById("u2_img").src = "images/recipes/" + "${recipelist[user.kitchen[0]].recipeid}" + ".png";
          ...
          if ("${user.kitchen[1]}" == "") {
        	  ...
        	  document.getElementById("u10_img").src = "images/recipes/" + "${recipelist[user.kitchen[1]].recipeid}" + ".png";
          ...
          if ("${user.kitchen[2]}" == "") {
        	  ...
        	  document.getElementById("u18_img").src = "images/recipes/" + "${recipelist[user.kitchen[2]].recipeid}" + ".png";
   ...
   <body onload="check()">
    <div id="base" class="">
      ...
      <div id="u2" class="ax_image">
        <a id="p0" href="recipe.jsp?id=${recipelist[user.kitchen[0]].recipeid}"><img id="u2_img" class="img " src="images/recipe/u37.png"/></a>
        <!-- Unnamed () -->
      ...
      <div id="u6" class="ax_paragraph">
        ...
        <div id="u7" class="text">
          <p><span><a id="p00" href="recipe.jsp?id=${recipelist[user.kitchen[0]].recipeid}">${recipelist[user.kitchen[0]].description}</a></span></p>
        </div>
      </div>
      ...
      <div id="u8" class="ax_h2">
        ...
        <div id="u9" class="text">
          <p><span><a id="p000" href="recipe.jsp?id=${recipelist[user.kitchen[0]].recipeid}">${recipelist[user.kitchen[0]].name}</a></span></p>
        </div>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u10" class="ax_image">
        <a id="p1" href="recipe.jsp?id=${recipelist[user.kitchen[1]].recipeid}"><img id="u10_img" class="img " src="images/recipe/u37.png"/></a>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_paragraph">
        ...
        <div id="u15" class="text">
          <p><span><a id="p11" href="recipe.jsp?id=${recipelist[user.kitchen[1]].recipeid}">${recipelist[user.kitchen[1]].description}</a></span></p>
        </div>
      </div>
      ...
      <div id="u16" class="ax_h2">
        ...
        <div id="u17" class="text">
          <p><span style="font-family:'AppleGothic', 'AppleGothic';font-weight:400;"><a id="p111" href="recipe.jsp?id=${recipelist[user.kitchen[1]].recipeid}">${recipelist[user.kitchen[1]].name}</a></span></p>
        </div>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u18" class="ax_image">
        <a id="p2" href="recipe.jsp?id=${recipelist[user.kitchen[2]].recipeid}"><img id="u18_img" class="img " src="images/recipe/u37.png"/></a>
        <!-- Unnamed () -->
      ...
      <div id="u22" class="ax_paragraph">
        ...
        <div id="u23" class="text">
          <p><span><a id="p22" href="recipe.jsp?id=${recipelist[user.kitchen[2]].recipeid}">${recipelist[user.kitchen[2]].description}</a></span></p>
        </div>
      </div>
      ...
      <div id="u24" class="ax_h2">
        ...
        <div id="u25" class="text">
          <p><span><a id="p222" href="recipe.jsp?id=${recipelist[user.kitchen[2]].recipeid}">${recipelist[user.kitchen[2]].name}</a></span></p>
        </div>
      </div>
    </div>
  </body>
